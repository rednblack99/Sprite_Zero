feature 'profile' do
  ...
  # context 'Account/profile deletion' do
  #   scenario 'A user can click a delete button on their private profile page' do
  #     visit 'privateprofile/1'
  #     click_on 'Delete profile'
  #   end

  #   scenario 'A user is taken to a confirm deletetion page after clicking delete' do
  #     visit 'privateprofile/1'
  #     click_on 'Delete profile'
  #     expect(page.current_path).to eq '/privateprofile/delete/1'
  #   end
  # end
